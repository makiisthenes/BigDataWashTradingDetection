...
if __name__ == "__main__":
    ...
    top_set = transactions.join(contracts)  # This is causing an infinite loop somewhere
    ...
    top10 = top_set.takeOrdered(10, key=lambda x: -int(x[1][0]))
    ...
    resource_bucket.put(Body=json.dumps(top10)) 
    spark.stop()
    ...
    # ccc method bucket cp -r bkt://object-bucket-ec20433-62ad507a-9907-4f6a-8055-7daeae09ffcc/part2-25-11-2022_11:51:29/ cw_output